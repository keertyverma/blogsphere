...
const HomePage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Feed | BlogSphere</title>
        <meta
          name="description"
          content="Explore the latest blogs, trending topics, and join a vibrant community of writers and readers on BlogSphere. Start your blogging journey today!"
        />
      </Helmet>
      <AnimationWrapper>
