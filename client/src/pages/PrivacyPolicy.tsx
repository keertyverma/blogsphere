  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Review BlogSphere's Privacy Policy to learn how we protect your data while you share, explore, and connect."
        />
      </Helmet>
      <div className="max-w-3xl mx-auto p-6 space-y-6 h-cover pt-20 pb-10">
        ...
        <div>
          ...
          <ul className="list-disc pl-12">
            <li>
              ...
              <br />
              We collect your email address and full name during registration.
              You can optionally upload a profile picture later by editing your
              user profile.
            </li>
            <li className="mt-1">
        ...
        <div>
          ...
          <p className="ml-6">
            ...
            except as required by law or to facilitate authentication (e.g.,
