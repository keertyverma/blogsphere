...
const ForgotPassword = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Forgot Password | BlogSphere</title>
        <meta
          name="description"
          content="Forgot your password? Enter your email address to receive a link to reset your password and regain access to your BlogSphere account."
        />
