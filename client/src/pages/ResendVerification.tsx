...
const ResendVerification = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Resend Verification | BlogSphere</title>
        <meta
          name="description"
          content="Didn't receive the verification email? Resend it to your registered email address and complete your BlogSphere account setup."
        />
          ...
          <div className="max-w-[450px] flex-center flex-col">
            ...
            {isSuccess && !errorMsg && (
              <div className="mt-2 max-sm:text-sm text-green-800 bg-green-100 dark:bg-green-800/50 dark:text-green-50 border border-green-400 p-2 rounded-md">
                <p>
                  If the email is associated with an account, a verification
