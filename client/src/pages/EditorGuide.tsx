...
const EditorJsUserGuide = () => {
  return (
    <>
      <Helmet>
        <title>Editor Guide | BlogSphere</title>
        <meta
          name="description"
          content="Explore the Blog Editor Guide for tips and tricks on using the editor effectively."
        />
      </Helmet>
      <div className="h-cover px-0 md:px-10 documentation">
        <section className="px-6 mx-auto md:max-w-[728px] flex flex-col gap-3 py-24">
            ...
            <ul>
              <li>
                ...
                <ul>
                  ...
                  <li>
                    <strong>Checklist</strong>: Creates an interactive
                    checklist.
                  </li>
                  <li>
          ...
          <div className="my-2">
            ...
            <ul>
              <li>
                <strong>Bold:</strong> Make key terms or phrases stand out
                (e.g., <strong>Important Point</strong>)
              </li>
              <li>
            ...
            <ul>
              <li>
                ...
                <ul>
                  ...
                  <li>
                    <strong>Ordered List - </strong> Use numbers to present
                    items in a sequence.
                    <ol>
                      <li>Step One</li>
                      <li>Step Two</li>
              ...
              <li>
                Use block tune setting {"  "}
                <PiDotsSixVerticalBold className="inline bg-input border-border border-[0.8px] rounded-md text-2xl p-0.5" />
                {"  "} to switch between unordered, ordered, and checklist
                styles.
              </li>
            </ul>
          </div>
          ...
          <div className="my-2">
            ...
            <ul>
              <li>
                <strong>📂 Upload from Your Device</strong> - Select an image
                from your device.
              </li>
              <li>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    extension or those with query parameters hiding the
                  ...
                  <div className="mt-3 p-2 border-l-4 border-green-500 bg-green-50 dark:bg-green-900/30 dark:border-green-400 text-green-900 dark:text-green-300">
                    ...
                    instead of{" "}
                    <span className="font-semibold">"Copy Image"</span> for a
                    valid link.
                  </div>
                </ul>
              </li>
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>
                    <strong>Background</strong>: Add a background to the image
                    for visual emphasis.
                  </li>
                  <li>
            ...
            <ul>
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>
                    The code will be formatted with appropriate colors and
                    styles.
                  </li>
                  <div className="w-70 md:w-96 my-2">
                    <img
